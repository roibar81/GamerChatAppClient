...
import com.example.gamerchatapp.adapter.FriendsAdapter;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        friendsRecyclerView = view.findViewById(R.id.friends_recyclerView_profile);
        friendsRecyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
        friendsRecyclerView.setLayoutManager(layoutManager);
        friendsRecyclerView.setItemAnimator(new DefaultItemAnimator());
        adapter = new FriendsAdapter(response);
